...
resource "aws_vpc" "main" {
  ...
  tags = {
    blueprint = "Stress Test Advisor to improve approval rate"
    environment = "production"
    Name = "agentbridge-stress-test-advisor-to-improve-approval-"
    Environment = "production"
    ManagedBy = "terraform"
  }
}
...
resource "aws_internet_gateway" "main" {
  ...
  tags = {
    Name = "agentbridge-stress-test-advisor-to-improve-approval--igw"
  }
}
...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "agentbridge-stress-test-advisor-to-improve-approval--public"
  }
}
...
resource "aws_route_table" "public" {
  ...
  tags = {
    Name = "agentbridge-stress-test-advisor-to-improve-approval--rt"
  }
}
...
resource "aws_security_group" "main" {
  name_prefix = "agentbridge-stress-test-advisor-to-improve-approval--"
  vpc_id      = aws_vpc.main.id
  ...
  tags = {
    Name = "agentbridge-stress-test-advisor-to-improve-approval--sg"
  }
...
resource "aws_key_pair" "deploy" {
  ...
  key_name   = "agentbridge-stress-test-advisor-to-improve-approval-"
...
resource "aws_eip" "main" {
  ...
  domain   = "vpc"
  tags = {
    Name = "agentbridge-stress-test-advisor-to-improve-approval--eip"
  }
}
...
resource "aws_ebs_volume" "data" {
  ...
  encrypted         = true
  tags = {
    Name = "agentbridge-stress-test-advisor-to-improve-approval--data"
  }
}
...
resource "aws_iam_role" "bedrock_flow" {
  ...
  name  = "agentbridge-stress-test-advisor-to-improve-approval--bedrock-role"
...
resource "aws_iam_role" "ec2_bedrock" {
  count = var.enable_bedrock ? 1 : 0
  name  = "agentbridge-stress-test-advisor-to-improve-approval--ec2-bedrock"
...
resource "aws_iam_instance_profile" "ec2_bedrock" {
  count = var.enable_bedrock ? 1 : 0
  name  = "agentbridge-stress-test-advisor-to-improve-approval--ec2-profile"
...
resource "aws_bedrockagent_flow" "main" {
  count              = var.enable_bedrock ? 1 : 0
  name               = "agentbridge-stress-test-advisor-to-improve-approval--flow"
